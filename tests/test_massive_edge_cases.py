...
DATETIME_EDGE_CASES = [
    ...
    ("2026-07-15T12:00:00+00:60", "2026-07-15T13:00:00+00:60", True, "Minute out of range offset"),
    ("2026-07-15T12:00:00+00:99", "2026-07-15T13:00:00+00:99", True, "Invalid minutes"),
    # Missing date/time components
    ("2026-07-15", "2026-07-15T01:00:00Z", True, "Date only"),
    ("12:00:00", "13:00:00", False, "Time only"),
    ("bad-string", "bad-string", False, "Completely invalid string"),
    ("2026-07-15T12:00", "2026-07-15T13:00", True, "Missing seconds component"),
